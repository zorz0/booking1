                    ...
                    <form action="{{ route('trips.store')}}" method="post" class="form-horizontal"
                        ...
                        <div class="form-body">
                            ...
                            <div class="row mb-2">
                                <div class="col col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <small class="text-danger"> برجاء ترك هذا الحقل فارغ اذا كنت تريد عدد ركاب غير
                                            نهائى</small>
                                        @error('child_price')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col col-md-6"> <label class="col-md-4 control-label">
    ...
    <script>
        ...
        $(document).ready(function () {
            jQuery('a.add-price').click(function (event) {
                ...
                var newRow = jQuery('<div class="row mb-2 tr"><div class="col col-md-4">' +
                    '<label class="col-md-4 control-label"> موعد الاقلاع</label>  <input type="datetime-local" name="leaving_date[]" class="form-control"></div><div class="col-md-4 form-group col-12 p-2">' +
                    '<label class="col-md-4 control-label"> موعد الوصول</label><input type="datetime-local" name="arriving_date[]" class="form-control"></div><div class="col-md-4 form-group col-12 p-2">' +

                    '  </div>  <div class="col col-md-2 form-group"> <a class="btn btn-air-primary btn-pill btn-danger add-price w-100" onclick="deletetr(this)" ><i class="fa fa-trash"></i></a>' +
